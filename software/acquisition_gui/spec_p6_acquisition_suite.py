...
@brief Master GUI Application - SPEC-P6 System
@details Graphical user interface for real-time telemetry, synchronization, 
         and DSP of the SPEC-P6 system. Manages ESP-NOW nodes, filters 
         photoplethysmography (MAX30102) and inertial (MPU6050) data, 
         estimates HR via Welch's method, and synchronizes BIOPAC triggers.
